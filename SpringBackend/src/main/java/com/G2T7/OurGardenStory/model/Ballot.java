...
public class Ballot {
    ...
    @DynamoDBAttribute
    private int numBidsPlaced; // JH: shouldn't this be derived? Not stored?
    ...
    static public class GardenConverter implements DynamoDBTypeConverter<String, Garden> {
        @Override
        public String convert(final Garden garden) {
        ...
        public Garden unconvert(final String stringValue) {
            ...
            garden.setLatitude(
                    stringValueList[5].substring(stringValueList[5].indexOf("=") + 1, stringValueList[5].length() - 1));
            return garden;
        }
    }
